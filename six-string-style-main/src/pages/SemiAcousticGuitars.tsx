    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-4 text-lg">Loading semi-acoustic guitars...</p>
        </div>
      </div>
    );
  }
        ...
        <div className="container mx-auto px-4">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-xl text-primary-foreground/90 max-w-3xl mx-auto mb-8">
              Experience the best of both worlds with semi-acoustic guitars. Perfect for jazz, blues, 
              and studio recording with both acoustic resonance and electric versatility.
            </p>
            ...
            <div className="max-w-4xl mx-auto mb-12">
              <div className="flex flex-col md:flex-row gap-4">
                <div className="relative flex-1">
                  ...
                  <Input
                    placeholder="Search semi-acoustic guitars..."
                    value={searchTerm}
        ...
        <div className="container mx-auto px-4">
          ...
          {filteredGuitars.length > 0 ? (
            ...
            <div className="text-center py-16">
              ...
              <h3 className="text-xl font-semibold text-primary mb-2">No semi-acoustic guitars found</h3>
          ...
          <div className="mt-16 text-center p-8 bg-gradient-to-r from-primary/5 to-secondary/5 rounded-2xl border border-primary/10">
            <h3 className="text-2xl font-bold text-primary mb-4">
              Need Help Choosing Your Semi-Acoustic Guitar?
            </h3>
            <p className="text-muted-foreground mb-6 max-w-2xl mx-auto">
              Our expert team is here to help you find the perfect semi-acoustic guitar. 
              Get personalized recommendations for jazz, blues, and studio recording.
            </p>
...
export default SemiAcousticGuitars; 